...
Catalog.prototype = {
  ...
  getCollectionById: function (id) {
    ...
    return this._request.get('/v1/market/catalog/collection?' + qs)
  },
  ...
  getItemById: function (id) {
    ...
    var qs = querystring.stringify({ id: id })
    return this._request.get('/v1/market/catalog/item?' + qs)
  },
  ...
  popularItemsBySite: function (site) {
    ...
    return this._request.get('/v1/market/popular:' + site + '.json')
  },
  ...
  categoriesBySite: function (site) {
    ...
    return this._request.get('/v1/market/categories:' + site + '.json')
  },
  ...
  getItemPricesById: function (id) {
    ...
    return this._request.get('/v1/market/item-prices:${id}.json')
  },
  ...
  getNewfilesBySiteAndCategory: function (params) {
    ...
    return this._request.get('/v1/market/new-files:' + site + ',' + category + '.json')
  },
  ...
  findFeaturedItemsBySite: function (site) {
    ...
    return this._request.get('/v1/market/features:' + site + '.json')
  },
  ...
  randomNewItemsBySite: function (params) {
    ...
    var site = params.site
    var category = params.category
    return this._request.get('/v1/market/random-new-files:' + site + ',' + category + '.json')
  }
}
